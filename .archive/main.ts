...
// as edições feitas nos svgs daqui geralmente envolvem uma stroke com largura 1
...
// https://simpleicons.org/?q=endeavouros
// EDITADO PRA VIRAR OUTLINE
// const svgEndeavourOs = `<svg
//    role="img"
//    viewBox="0 0 24 24"
//    version="1.1"
...
//   <path
//      d="m 11.995111,11.996586 v 0.002 c 0.022,0.01 0,0.002 0,-0.002 z" />
//   <path
//      d="m 13.942542,3.2099885 v 0.00176 C 13.301189,3.2999719 1.5654073,17.699086 1.5654073,17.699086 c 0,0 0.8442564,0.239956 2.7656675,0.518729 0,0 9.2056592,-15.0510538 9.6194062,-15.0042977 -8.82e-4,0 -0.0088,-0.00529 -0.0088,-0.00353 z M 4.3310748,18.217815 c -0.8380811,1.377981 -1.5085459,2.486013 -1.5085459,2.486013 0,0 9.0142241,0.405807 16.0249921,-0.534608 9.919347,-1.329831 -1.818739,-14.0762455 -4.738554,-17.0426741 -0.01662,-0.016886 -0.03296,-0.033455 -0.049,-0.049703 2.242528,2.9641604 11.885754,15.6597642 2.169307,15.8238522 -3.431722,0.05822 -11.8982002,-0.68288 -11.8982002,-0.68288 z"
//      style="fill:none;stroke:currentColor;stroke-width:0.882191;stroke-opacity:1" />
// </svg>
// `;
...
export default class FileGlyphs extends Plugin {
	...
	runIconVerification() {
		...
		directories.forEach(d => {
			...
			//else if (folderName.startsWith('endeavour')) {
			//	 svgContents = svgEndeavourOs;
			//}
